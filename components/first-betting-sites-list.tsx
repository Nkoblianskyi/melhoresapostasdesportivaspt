...
export function FirstBettingSitesList() {
  ...
  const getBadgeText = (index: number) => {
    const badges = ["Marca Top", "Oferta Exclusiva", "Altamente Avaliado", "Tendência Quente"]
              ...
              <Card
                ...
                className={`overflow-hidden transition-all duration-300 hover:scale-[1.02] animate-fadeIn relative ${
                  index === 0
                    ...
                    : "shadow-lg hover:shadow-xl bg-white border-4 border-gray-200 hover:border-green-500"
                }`}
                ...
                <Link href={site.url} target="_blank" rel="noopener noreferrer" className="block">
                  <CardContent className="p-0 h-full">
                    ...
                    <div className="flex flex-col md:hidden">
                      <div className="grid grid-cols-2">
                        ...
                        <div className="bg-white p-4 flex flex-col items-center justify-center space-y-3">
                          <div className="text-center">
                            <div className="text-red-500 mb-1 font-bold text-lg">Bónus de Boas-Vindas</div>
                    ...
                    <div className="hidden md:flex items-center h-full">
                      {/* Logo section */}
                      <div className="bg-white h-full flex items-center border-r border-gray-200">
